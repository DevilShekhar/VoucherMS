    ...
    <div class="premium-header">
        ...
        <div class="premium-header-left">
            ...
            <div class="premium-header-content">
                ...
                <h2 class="text-white">Online Exam Schedule</h2>
                <p>Manage all online exam schedules</p>
            </div>
        </div>
...
<section class="section premium-dashboard pt-0">
    <div class="card premium-block">
        ...
        <div class="card-header premium-card-header">
            <div>
                <h4 class="mb-1">All Online Exam Schedules</h4>
                <p class="header-subtext mb-0">
                    View and manage all scheduled online examinations.
                </p>
            </div>
        </div>
                        ...
                        @empty
                            ...
                            <tr>
                                <td colspan="8" class="text-center py-5">
                                    ...
                                    <h6>No Online Exam Schedule Found</h6>
                                </td>
                            </tr>

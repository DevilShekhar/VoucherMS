                        ...
                        <tbody>
                            @forelse($lead->followups as $followup)
                                <tr>
                                    ...
                                    <td>
                                        @if($followup->next_followup)
                                            {{ \Carbon\Carbon::parse($followup->next_followup)->format('d M Y') }}
                                        @else
                                            -
                                        @endif
                                    </td>
                                    <td>
                                        <span class="badge bg-{{ in_array($followup->status, ['Converted', 'Closed']) ? 'success' : 'info' }}">
                                            {{ $followup->status }}
                                        </span>
                                    </td>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="next_followup" class="form-control" value="{{ old('next_followup') }}" min="{{ now()->addDay()->format('Y-m-d') }}">
                        </div>
                    </div>

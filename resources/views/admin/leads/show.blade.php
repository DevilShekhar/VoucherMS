                ...
                <div class="lead-hero-content">
                    ...
                    <div class="lead-right">
                        ...
                        <div class="hero-buttons">
                            ...
                            <button class="hero-btn dark" data-bs-toggle="modal" data-bs-target="#addFollowupModal">
                                        ...
                                        <div class="col-md-6">
                                            <div class="lead-info-item">
                                                ...
                                                <div>
                                                    ...
                                                    <h6>{{ $lead->course?->category?->name ?? '-' }}</h6>
            ...
            <div class="col-lg-12" id="followup-history">
                <div class="premium-profile-card">
                    <div class="profile-section-title">
                        ...
                        <button class="premium-add-btn ms-auto text-white" data-bs-toggle="modal"
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content">
                                    <div class="timeline-header">
                                        <div>
                                            <h5> {{ $followup->followup_date ? \Carbon\Carbon::parse($followup->followup_date)->format('d M Y, h:i A') : now()->format('d M Y, h:i A') }}
                                            </h5>
                                    ...
                                    <div class="timeline-footer">
                                        <span>
                                            ...
                                            Next Follow-up :
                                            {{ $followup->next_followup ? \Carbon\Carbon::parse($followup->next_followup)->format('d M Y, h:i A') : 'Not Scheduled' }}
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-body p-4">
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="datetime-local" name="next_followup" class="form-control premium-input"
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="discussion" rows="6" class="form-control premium-input"
                                        placeholder="Enter detailed discussion with candidate..."
                                        required>{{ old('discussion') }}</textarea>
                                </div>
                            </div>
                        </div>

    ...
    <div class="premium-floating-header">
        <div class="header-content">
            ...
            <div class="premium-head-actions">
                <a href="{{ route('candidates.index') }}" class="btn mb-2" style="background:var(--cloth);color:var(--ink);">
                    <i class="fas fa-arrow-left"></i> Back
                </a>
                <button class="btn btn-warning mb-2 upload-doc-btn"
                        ...
                        <div class="col-lg-5">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="ms-4">
                                    ...
                                    <span class="badge bg-{{ $candidate->status == 'Active' ? 'success' : 'warning' }} mt-2">
                                        {{ $candidate->status }}
                                    </span>
                                </div>
                            </div>
        ...
        <div class="col-lg-12">
            <div class="card premium-block">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    ...
                    <button class="btn btn-success btn-sm upload-doc-btn"
                            data-candidate-id="{{ $candidate->id }}"
                            data-candidate-name="{{ $candidate->first_name }} {{ $candidate->last_name ?? '' }}"
                            data-candidate-code="{{ $candidate->candidate_code }}">
                                ...
                                <tbody>
                                    @foreach($candidate->documents as $index => $doc)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge" style="background: #0d6efd; color: white; padding: 6px 12px; font-size: 0.85rem;">

                ...
                <div class="premium-header-right">
                    ...
                    @if($voucherRequest->status == 'Approved')
                        <form id="allocateForm" action="{{ route('voucher-requests.allocate', $voucherRequest) }}" method="POST"
                            class="m-0">
                            @csrf
                            <button type="button" id="allocateBtn" class="premium-back-btn text-success" title="Allocate voucher to this candidate">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="detail-box no-border">
                                ...
                                <div class="detail-content">
                                    ...
                                    <h6>{{ $voucherRequest->requested_at ? \Carbon\Carbon::parse($voucherRequest->requested_at)->format('d M Y h:i A') : '-' }}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="premium-request-card approval-card">
                            <div class="premium-request-header">
                                <div class="header-left">
                                    ...
                                    <div>
                                        <h4>Approval</h4>
                                        <p>Approve or reject this voucher request.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="premium-request-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div  class="col-md-4 mb-4"  id="sellingPriceBox">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input  type="number" class="form-control premium-input"  name="selling_price"  step="0.01"  min="0"  placeholder="Enter selling price">
                                            </div>
                                        </div>
                                        <!-- Remarks -->
                                        <div class="col-md-4 mb-4">
                                            <label class="form-label">  Remarks </label>
                                            <textarea class="form-control premium-input" rows="3"  name="remarks"  placeholder="Enter remarks..."></textarea>
                                        </div>
                                    </div>
                                    <button
                                       class="btn btn-success premium-submit-btn">
